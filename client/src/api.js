    ...
    <div className="container">
      ...
      <h2>Add New Client</h2>
        <form onSubmit={handleSubmit}>
          ...
          <label>Install Date: <input name="install_date" type="date" value={formData.install_date ? formData.install_date.substring(0, 10) : ''} onChange={handleChange} /></label>
          <label>Next Service Date: <input name="next_service_date" type="date" value={formData.next_service_date ? formData.next_service_date.substring(0, 10) : ''} onChange={handleChange} /></label>
